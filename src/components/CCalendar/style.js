...
export const processedColor = "#56a7b6";
export const processingColor = "#56a7b6";
export const failedColor = "rgba(246, 126, 126,1)";

export const textDefaultColor = "#2d4150";
export const textColor = "#43515c";
export const textLinkColor = "#56a7b6";
export const textSecondaryColor = "#7a92a5";

export const textDayFontFamily = "OpenSans-Bold";
export const textMonthFontFamily = "OpenSans-Bold";
export const textDayHeaderFontFamily = "OpenSans-Bold";
