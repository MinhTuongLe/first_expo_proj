...
class Api {
  ...
  static get(route: string, version = "v1") {
    return this.xhr(route, null, "GET", version);
  }

  static put(route: string, params: any, version: string = "v1") {
    return this.xhr(route, params, "PUT", version);
  }

  static post(route: string, params: any, version: string = "v1") {
    return this.xhr(route, params, "POST", version);
  }

  static delete(route: string, params: any, version: string = "v1") {
    return this.xhr(route, params, "DELETE", version);
  }

  static async upload(route: string, params: any, version: string = "v1") {
    ...
    if (params.typeChange === "Avatar") {
      let _avatarUpload: any = new FormData();
      ...
      params.files.forEach((element: any) => {
        const newFile: any = {
