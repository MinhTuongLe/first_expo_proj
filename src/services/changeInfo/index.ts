...
export default {
  ...
  changeInfoParent: async (params: any) => {
    try {
  ...
  changeAvatarParent: async (params: any) => {
    try {
      let newUrl =
        sailsApi.changeInfoParent.avatar +
        "?id=" +
        params.id +
        "&school=" +
        params.school;
  ...
  changeAvatar: async (params: any) => {
    try {
      let newUrl =
        sailsApi.changeInfo.avatar +
        "?id=" +
        params.id +
        "&school=" +
        params.school;
  ...
  changeAvatarStudent: async (params: any) => {
    try {
      let newUrl =
        sailsApi.student.avatar +
        "?id=" +
        params.id +
        "&school=" +
        params.school;
