...
export function percentSaleProduct(regular_price: string, sale_price: string) {
 ...
 * @returns {*}
 */
export function prepareProductItem(
  item: any,
  currency: string,
 ...
 * @returns {*}
 */
export function calcCost(method: any, order: any) {
 ...
 */
export function checkQuantity(product: any, quantity: number) {
  let check = false;
