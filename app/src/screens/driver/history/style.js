...
const styles = Object.assign({}, CommonStyle, {
  ...
  con_drove_kid: [{paddingHorizontal: 10, paddingTop: 15}],
  ...
  rowItemStudent: [
    DEVICE.gStyle.row_align_center,
    {height: Helpers.wS('20%'), width: '100%', justifyContent: 'flex-start'},
  ],
  nameIconArea: [
    DEVICE.gStyle.row_align_center,
    {
  ...
  txtNameStudent: [DEVICE.initFont.X_SMALL, {fontFamily: DEVICE.fontBold}],
