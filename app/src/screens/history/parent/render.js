      ...
      <ScrollView style={styles.con}>
        ...
        <View style={styles.con_detail}>
          <View style={{ flexDirection: 'row', marginLeft: 10 }}>
            ...
            <CText style={styles.txt_row_detail}>{' ' + moment(state._currentDate).format("DD/MM/YYYY") + ":"}</CText>
          </View>
          <View style={styles.con_row_detail}>
            <View style={[styles.con_row_icon, { backgroundColor: COLOR.primaryApp }]} />
            <CText style={styles.txt_row_detail} i18nKey={"present"} />
            <CText style={styles.txt_row_detail}>{`: ${state._data ? state._data.countPresent : 0} `}</CText>
            <CText style={styles.txt_row_detail} i18nKey={"totalStudent"} />
          </View>
          <View style={styles.con_row_detail} >
            <View style={[styles.con_row_icon, { backgroundColor: COLOR.primaryTextNote }]} />
            <CText style={styles.txt_row_detail} i18nKey={"absent"} />
            <CText style={styles.txt_row_detail}>{`: ${state._data ? state._data.countAbsent : 0} `}</CText>
            <CText style={styles.txt_row_detail} i18nKey={"totalStudent"} />
          </View>
        </View>
        <View style={styles.con_detail}>
          <View style={{ flexDirection: 'row', marginLeft: 10 }}>
            ...
            <CText style={styles.txt_row_detail}>{' ' + moment(state._currentDate).format("MM - yyyy") + ":"}</CText>
          </View>
          <View style={styles.con_row_detail} >
            <View style={[styles.con_row_icon, { backgroundColor: COLOR.primaryApp }]} />
            <CText style={styles.txt_row_detail} i18nKey={"present"} />
            <CText style={styles.txt_row_detail}>{`: ${state._dataMonth ? state._dataMonth.countPresent : 0} `}</CText>
            <CText style={styles.txt_row_detail} i18nKey={"totalStudent"} />
          </View>
          <View style={styles.con_row_detail} >
            <View style={[styles.con_row_icon, { backgroundColor: COLOR.primaryTextNote }]} />
            <CText style={styles.txt_row_detail} i18nKey={"absent"} />
            <CText style={styles.txt_row_detail}>{`: ${state._dataMonth ? state._dataMonth.countAbsent : 0} `}</CText>
            <CText style={styles.txt_row_detail} i18nKey={"totalStudent"} />
          </View>
        </View>
      </ScrollView>
