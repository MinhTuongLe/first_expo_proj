...
export const foregroundColor = COLOR.backgroundMain;
export const backgroundColor = '#f4f4f4';
export const separatorColor = '#e8e9ec';

export const processedColor = COLOR.primaryApp;
export const processingColor = COLOR.primaryButton;
export const failedColor = 'rgba(246, 126, 126,1)';

export const textDefaultColor = '#2d4150';
export const textColor = '#43515c';
export const textLinkColor = COLOR.primaryButton;
export const textSecondaryColor = '#7a92a5';

export const textDayFontFamily = DEVICE.fontBold;
export const textMonthFontFamily = DEVICE.fontBold;
export const textDayHeaderFontFamily = DEVICE.fontBold;
