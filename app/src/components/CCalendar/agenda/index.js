...
export default class CCalendar extends Component {
  static propTypes = {
    ...
    // Show/Hide calendar. Default = true
  ...
  render() {
    ...
    if (!this.props.hideKnob) {
      const knobViewWhenCalClose = this.props.renderKnobOpen ? (
        this.props.renderKnobOpen()
      ) : (
        <View style={this.styles.knob} />
      );
      const knobViewWhenCalOpen = this.props.renderKnobClose ? (
        this.props.renderKnobClose()
      ) : (
        <View style={this.styles.knob} />
      );
      knob = this.state.calendarScrollable ? (
        ...
        <View style={this.styles.knobContainer}>
          <View ref={c => (this.knob = c)}>{knobViewWhenCalClose}</View>
        </View>
      );
    }
